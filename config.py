...
EMOTION_BENCHMARKS_DIR = BENCHMARKS_DIR / "emotion_models"
FACE_BENCHMARKS_DIR = BENCHMARKS_DIR / "face_detectors"
...
DEFAULT_STATE_WINDOW_SECONDS = 3.0
DEFAULT_STATE_PERSISTENCE_FRAMES = 10
